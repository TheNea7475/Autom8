...
***Info about the xfoil version used for this build:***
XFOIL Version 6.99
...
The pre-processing nature of STL Autom8 is to effectively and automatically extract geometric data about the profile, submitted in a compact and easy to read format, eliminating the repetitive CAD task of manually slicing and analysing 3D files. The first module produces a table where this information is stored. This is the data required as input by the Rot8 module.
