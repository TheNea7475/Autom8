...
function Report=GeometryExtractor(stlPath,AirfDir,GraphDir,PADDir,GenerateGif,steps,d,Holdgraphs,DebugGraphNumbered,range_rpm,UnitFactor,Soundspeed,ni)
    ...
    for z = zscan
        ...
        parfor c=1:size(XX,1)                                                   %Counter for not losing points ids
