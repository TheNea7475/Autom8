...
function Report=GeometryExtractor_fast_serial(stlPath,AirfDir,GraphDir,PADDir,GenerateGif,steps,d,Holdgraphs,DebugGraphNumbered,range_rpm,UnitFactor,Soundspeed,ni)
